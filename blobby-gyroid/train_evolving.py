...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-type", type=str, default="metaballs", choices=["evolving", "metaballs"])
    parser.add_argument("--iters", type=int, default=4000)
    parser.add_argument("--n-blobs", type=int, default=16, help="Number of blobs/balls")
    parser.add_argument("--hidden-dynamics", type=int, default=0, help="Hidden size for dynamics net (0=disabled)")
    parser.add_argument("--hidden-query", type=int, default=128, help="Hidden size for query net")
    parser.add_argument("--hidden-summary", type=int, default=0, help="Hidden size for blob summary (0=use raw)")
    parser.add_argument("--pos-enc-L", type=int, default=6, help="Positional encoding frequency levels")
